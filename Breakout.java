...
/** Number of turns */
	...
	public void board(){
		...
		add(nn2);
		GLine nn3 = new GLine(startx+(BRICK_WIDTH)+(BRICK_SEP)+3+APPLICATION_WIDTH,starty,startx+(BRICK_WIDTH)+(BRICK_SEP)+3+APPLICATION_WIDTH,starty-3+APPLICATION_HEIGHT);
		add(nn3);
