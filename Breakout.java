...
/** Number of turns */
	...
	public void board(){
		...
		add(nn2);
		GLine nn3 = new GLine(startx+(BRICK_WIDTH)+(BRICK_SEP)+2+APPLICATION_WIDTH,starty-1,startx+(BRICK_WIDTH)+(BRICK_SEP)+2+APPLICATION_WIDTH,starty-1+APPLICATION_HEIGHT);
		add(nn3);
