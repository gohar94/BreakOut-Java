...
/** Number of turns */
	...
	public void board(){
		...
		add(nn3);
		GLine nn4 = new GLine(startx+(BRICK_WIDTH)+(BRICK_SEP)+3+APPLICATION_WIDTH,starty-2,startx+(BRICK_WIDTH)+(BRICK_SEP)+3+APPLICATION_WIDTH,starty-3+APPLICATION_HEIGHT);
		add(nn4);
