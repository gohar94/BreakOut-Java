...
/** Number of turns */
	...
	public void board(){
		...
		add(nn3);
		GLine nn1 = new GLine(startx+(BRICK_WIDTH)+(BRICK_SEP)-3,starty-1+APPLICATION_HEIGHT,startx+(BRICK_WIDTH)+(BRICK_SEP)+3+APPLICATION_WIDTH,starty-1+APPLICATION_HEIGHT);
		add(nn1);
